...
class RectangleObject(object):
    ...
    # Getter
    @addattr(short_description=_(u"Dimension"))
    ...
    @addattr(short_description=_(u"Ratio"))
...
class RectangleModel(models.Model, RectangleObject):
    ...
    width = models.IntegerField(default=0, blank=True, null=True, verbose_name=pgettext_lazy("geometry", u"Width"))
    height = models.IntegerField(default=0, blank=True, null=True, verbose_name=pgettext_lazy("geometry", u"Height"))
...
class FloatRectangleModel(models.Model, RectangleObject):
    ...
    width = models.FloatField(default=0.0, blank=True, null=True, verbose_name=pgettext_lazy("geometry", u"Width"))
    height = models.FloatField(default=0.0, blank=True, null=True, verbose_name=pgettext_lazy("geometry", u"Height"))
