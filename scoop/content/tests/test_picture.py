...
class PictureTest(TestCase):
    ...
    def setUp(self):
        ...
        self.picture1 = Picture.objects.create_from_uri("find://flower?id=0", author=self.user, title=u"Flower")
    ...
    def test_picture(self):
        ...
        self.assertGreater(self.picture1.get_file_size(raw=True), 1800, u"the downloaded picture should be bigger than 1800 bytes")
        self.assertTrue(self.picture2.get_animations().count() > 0, u"the downloaded picture should have animations attached")
        self.assertTrue(self.picture2.animated is True, u"the downloaded picture should have the animated attribute")
