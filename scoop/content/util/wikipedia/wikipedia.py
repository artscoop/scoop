...
class WikipediaError(Exception):
    """ Exception spécialisée pour l'outil Wikipedia """
    pass
...
class Wikipedia:
    ...
    def __init__(self, lang):
        """ Initialiser le parser en choisissant la langue Wikipedia """
        self.lang = lang
    ...
    def article(self, article):
        """ Renvoyer le contenu de l'article Wikipedia """
    ...
    def search(self, query, page=1, limit=10):
        ...
        if search:
            for article in search:
                ...
                results.append({'title': title, 'snippet': snippet, 'wordcount': wordcount})

        # yaml.dump(results, default_style='', default_flow_style=False, allow_unicode=True)
        return results
