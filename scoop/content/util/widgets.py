...
class InlineWidget(forms.Widget):
    ...
    def render(self, name, value, attrs=None):
        """ Rendre le widget """
        output = render_to_string("content/display/inline-widget.html", {'value': value})
        return mark_safe(output)
...
class CreationLicenseWidget(forms.MultiWidget):
    ...
    # Constantes
    COPYRIGHTED = {1: _(u"Copyright")}
    CREATIVE_COMMONS = {10: _(u"CC BY - Attribution"), 11: _(u"CC BY-SA - Share alike"), 12: _(u"CC BY-ND - Cannot edit"), 13: _(u"CC BY-NC - Non commercial"), 14: _(u"CC BY-NC-SA - SA+NC"),
                        15: _(u"CC BY-NC-ND - ND+NC"), 16: _(u"Public domain")}
    ...
    def __init__(self, attrs=None, widget=None):
        ...
        _widgets = (license_widget, widgets.TextInput(attrs={u'class': u'license-author', u'placeholder': _(u"Creator or rights holder")}))
    ...
    def get_choices():
        ...
        cc_choices = [[0, pgettext_lazy('license', u"None")], [_(u"Creative Commons"), CreationLicenseWidget.CREATIVE_COMMONS.items()],
                      [_(u"Copyright"), CreationLicenseWidget.COPYRIGHTED.items()]]
        return cc_choices
