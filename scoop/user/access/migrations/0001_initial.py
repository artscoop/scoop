    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(related_name='userips', verbose_name='User', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='access',
            name='ip',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='IP', to='access.IP', null=True),
        ),
        migrations.AddField(
            model_name='access',
            name='page',
            field=models.ForeignKey(related_name='access_log', verbose_name='Page', to='access.Page'),
        ),
        migrations.AddField(
            model_name='access',
            name='user',
            field=models.ForeignKey(related_name='access_log', on_delete=django.db.models.deletion.SET_NULL, verbose_name='User', to=settings.AUTH_USER_MODEL, null=True),
        ),
