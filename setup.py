...
setup(
    ...
    requires=['django', 'bleach', 'beautifulsoup', 'beautifulsoup4', 'bpython', 'coverage', 'django_autoslug', 'django_celery', 'django_jsonresponse', 'django_simple_captcha',
              'django_static_sitemaps', 'django_translatable', 'dj_cmd', 'dnspython', 'fuzzywuzzy', 'gunicorn', 'html5lib', 'ipy', 'ipython', 'isort', 'loremipsum', 'lxml', 'markdown',
              'mysql_python', 'ngram', 'nltk', 'numpy', 'paramiko', 'pexpect', 'pillow', 'psycopg2', 'pyproj', 'python_levenshtein', 'python_dateutil', 'python_magic', 'pytz', 'requests',
