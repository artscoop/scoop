...
setup(
    ...
    requires=['django', 'bleach', 'beautifulsoup4', 'bpython', 'coverage', 'django_autoslug', 'celery', 'django_jsonresponse', 'django_reversion',
              'django_simple_captcha', 'django_translatable', 'dj_cmd', 'dnspython3', 'flower', 'fuzzywuzzy', 'gunicorn', 'html5lib', 'ipy', 'ipython', 'isort',
              'loremipsum', 'lxml', 'markdown', 'micawber', 'mysqlclient', 'ngram', 'nltk', 'numpy', 'paramiko', 'pexpect', 'pillow', 'psycopg2', 'pyproj',
              'python_levenshtein', 'python_dateutil', 'python_magic', 'pytz', 'rarfile', 'requests', 'simplejson', 'textblob', 'textile', 'unicodecsv',
              'unidecode'],
