...
setup(
    ...
    requires=['django', 'bleach', 'beautifulsoup4', 'bpython', 'coverage', 'django_autoslug', 'django_celery', 'django_jsonresponse',
              'django_simple_captcha',
              'django_translatable', 'dj_cmd', 'dnspython3', 'fuzzywuzzy', 'gunicorn', 'html5lib', 'ipy', 'ipython', 'isort', 'loremipsum', 'lxml',
              'markdown',
              'micawber', 'mysqlclient', 'ngram', 'nltk', 'numpy', 'paramiko', 'pexpect', 'pillow', 'psycopg2', 'pyproj', 'python_levenshtein',
              'python_dateutil', 'python_magic', 'pytz', 'rarfile', 'requests', 'simplejson', 'textblob', 'unicodecsv', 'unidecode'],
